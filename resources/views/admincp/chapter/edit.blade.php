                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('chapter.update', [$chapter->id])}}">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="tieude" onkeyup="ChangeToSlug()"  value="{{$chapter->tieude}}" id="slug" aria-describedby="emailHelp" placeholder="Nhập tiêu đề chapter...">
                      </div>

                      <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Slug chapter</label>
                        <input type="text" class="form-control" name="slug_chapter"  value="{{$chapter->slug_chapter}}" id="convert_slug" aria-describedby="emailHelp" placeholder="Nhập slug chapter...">
                      </div>

                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Tóm tắt chapter</label>
                        <input type="text" class="form-control" value="{{$chapter->tomtat}}"  name="tomtat" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nội dung chapter...">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="noidung_chapter"  name="noidung" style="resize: none;" rows="5">{{$chapter->noidung}}</textarea>
                    </div>
